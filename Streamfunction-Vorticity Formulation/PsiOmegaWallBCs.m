...
% given streamfunction boundary conditions for walls.
...
%     times=[0.1 0.5 1.5 3];
%     t= times(kk);
%     fprintf('x-Velocity (u) @ (0.15,0.25) q=%0.1f t=%0.1f is %0.3f \n',q,t,uuuu(16,26));
%     fprintf('y-Velocity (v) @ (0.15,0.25) q=%0.1f t=%0.1f is %0.3f \n',q,t,vvvv(16,26));
%     fprintf('Vorticity @ (0.15,0.25) q=%0.1f t=%0.1f is %0.3f \n',q,t,vort(26,16));
% end